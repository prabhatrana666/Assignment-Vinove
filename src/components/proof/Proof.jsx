...
import "./Proof.css";
import leftiage from "../../assets/vinove-images/mobile images_left.png";
import rightiage from "../../assets/vinove-images/mobile images_right.png";
                            ...
                            >
                                ...
                                <article className="proof-project-card">
                                    ...
                                    >
                                        ...
                                        <img src={leftiage} alt="leftiage" />
                                        {/* Decorative browser/app mocku<img src={leftiage} alt="leftiage" />p */}
                            ...
                            <div className="proof-faq-list">
                                ...
                                {faqItems.map((item, index) => {
                                    ...
                                    return (
                                        ...
                                        <div
                                            className={`proof-faq-item ${isActive ? "proof-faq-active" : ""
                                                }`}
                                            key={item.question}
                                        >
                                            ...
                                            <div
                                                className={`proof-faq-answer ${isActive ? "proof-faq-answer-open" : ""
                                                    }`}
                                            >
